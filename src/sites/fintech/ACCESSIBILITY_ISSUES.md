...
| IGT-016 | Home      | `Home.jsx` hero CTA pair `<div style={{flexDirection:'row-reverse'}}>` — visual order ≠ DOM order | 1.3.2 | Reading Order IGT | Serious | **IGT** (Reading Order) | Live |
...
| IGT-016 | Reading Order   | `/#/fintech` (Home)               | The "Get started" / "See Smart Savings" CTA pair below the hero copy.                | Run the **Reading Order** IGT. Visually "See Smart Savings" appears first, but DOM has "Get started" first. SE turns on a screen reader and shows that NVDA/VO read DOM order, mismatching the visual.                                       |
