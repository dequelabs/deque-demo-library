...
| MT-080 | Home      | `Home.jsx` nested `<button>` (`.testimonial-preview-btn`) inside the "Read their stories" `<Link>` in the testimonial card | 4.1.2 | `nested-interactive`           | Serious  | axe-core | Live |
